...
fetchDataFromServer(
  ...
  function (movie) {
    const {
      ...
      vote_average,
      releases: {
        countries: [{ certification }] = [{ certification: "NR" }]
      },
      genres,
      overview,
      casts: { cast, crew },
    ...
    movieDetail.innerHTML = `
      ...
      <div class="detail-box">
        ...
        <div class="video-container">
          <h3 class="heading">Смотреть онлайн</h3>
          <iframe src="https://voidboost.net/embed/${movieId}" width="100%" height="480" allowfullscreen loading="lazy"></iframe>
        </div>
      </div>
    `;
